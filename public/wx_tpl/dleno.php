                ...
                <ul class="user_list">
                    <li class="user_active">
                        ...
                        <div class="user_text">
                            ...
                            <input type="hidden" value="2" id="userId" name="userId">
                        </div>
...
<script type="text/javascript">
    var wsServer = 'ws:192.168.33.66:9503?userId=1';
    ...
    window.onload=function(){
        ...
        websocket.onclose = function (evt) {
            ...
            chat.innerHTML += '<li class="other"><img src="'+'images/own_head.jpg'+'"><span>'+Disconnected+'</span></li>';
        };
